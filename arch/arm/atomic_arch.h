...
#if ((__ARM_ARCH_6__ || __ARM_ARCH_6K__ || __ARM_ARCH_6KZ__ || __ARM_ARCH_6ZK__) && !__thumb__) || __ARM_ARCH_6T2__ || __ARM_ARCH_7A__ || __ARM_ARCH_7R__ || \
    __ARM_ARCH >= 7
...
static inline int a_cas(volatile int *p, int t, int s) {
  for (;;) {
    ...
    int old;
    __asm__ __volatile__(BLX " r3" : "+r"(r0), "+r"(r3) : "r"(r1), "r"(r2) : "memory", "lr", "ip", "cc");
    if (!r0) return t;
