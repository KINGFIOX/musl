...
static inline long __syscall5(long n, long a1, long a2, long a3, long a4, long a5) {
  unsigned long __ret;
#if !defined(__PIC__) || !defined(BROKEN_EBX_ASM)
  __asm__ __volatile__(SYSCALL_INSNS : "=a"(__ret) : "a"(n), "b"(a1), "c"(a2), "d"(a3), "S"(a4), "D"(a5) : "memory");
#else
...
static inline long __syscall6(long n, long a1, long a2, long a3, long a4, long a5, long a6) {
  ...
  __asm__ __volatile__("pushl %1 ; push %%ebx ; push %%ebp ; mov 8(%%esp),%%ebx ; mov 4(%%ebx),%%ebp ; mov (%%ebx),%%ebx ; " SYSCALL_INSNS
