...
int _flush_cache(void *addr, int len, int op) { return syscall(SYS_cacheflush, addr, len, op); }
weak_alias(_flush_cache, cacheflush);
#endif

#ifdef SYS_cachectl
int __cachectl(void *addr, int len, int op) { return syscall(SYS_cachectl, addr, len, op); }
...
static int flush_icache_init(void *start, void *end, unsigned long int flags) {
  ...
  int (*f)(void *, void *, unsigned long int) = (int (*)(void *, void *, unsigned long int))p;
...
int __riscv_flush_icache(void *start, void *end, unsigned long int flags) {
  int (*f)(void *, void *, unsigned long int) = (int (*)(void *, void *, unsigned long int))vdso_func;
  if (f) {
