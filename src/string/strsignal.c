...
#if (SIGHUP == 1) && (SIGINT == 2) && (SIGQUIT == 3) && (SIGILL == 4) && (SIGTRAP == 5) && (SIGABRT == 6) && (SIGBUS == 7) && (SIGFPE == 8) &&               \
...
static const char map[] = {[SIGHUP] = 1,     [SIGINT] = 2,     [SIGQUIT] = 3,  [SIGILL] = 4,    [SIGTRAP] = 5,  [SIGABRT] = 6,  [SIGBUS] = 7,   [SIGFPE] = 8,
