...
static inline void set_fpscr_f(double fpscr) { __asm__ __volatile__("mtfsf 255, %0" : : "d"(fpscr)); }
...
int fetestexcept(int mask) { return get_fpscr() & mask & FE_ALL_EXCEPT; }

int fegetround(void) { return get_fpscr() & 3; }
